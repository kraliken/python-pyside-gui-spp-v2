...
class BankAccountEditView(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.ba_type_combo = QComboBox()
        self.ba_type_combo.addItems(
            ["Folyószámla", "Deviza számla", "Operatív számla", "Tartalék számla"]
        )
        self.ba_type_combo.setEnabled(False)
        detail_layout.addWidget(self.ba_type_combo)

        detail_layout.addWidget(self._make_field_label("Partner"))
        self.ba_partner_edit = QLineEdit()
        self.ba_partner_edit.setEnabled(False)
        detail_layout.addWidget(self.ba_partner_edit)
