...
class CustomerQueryView(QWidget):
    def __init__(self):
        ...
        set_button_icon(self.save_to_irems_hist_table_button, ICON_HISTORY, CLR_SECONDARY, CLR_SECONDARY_DIS)
    ...
    def load_data(self):
        try:
            ...
            if df.empty:
                ...
                self.save_to_irems_hist_table_button.setEnabled(True)
    ...
    def perform_save_to_irems_hist_table(self):
        success, message = self.db.call_customer_insert1()
